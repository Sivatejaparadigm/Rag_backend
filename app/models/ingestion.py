...
class IngestionJob(Base):
    ...
    source_uri: Mapped[str] = mapped_column(String(1000), nullable=True)

    # Destination tracking
    destination_type: Mapped[str] = mapped_column(String(50), nullable=True)
    destination_uri: Mapped[str] = mapped_column(String(1000), nullable=True)
